...
namespace NerdStore.Vendas.Application.Commands
{
...

    {
        ...
        public async Task<bool> Handle(AplicarVoucherPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            //atualizar voucher,pois ele foi usado e precisamos diminuir a qtd disponivel.
            voucher.AtualizarQuantidadeVoucher();
            _pedidoRepository.AtualizarQuantidadeVoucher(voucher);
